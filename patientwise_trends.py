...
import argparse
parser = argparse.ArgumentParser(description = "Run SPO2 Calculation for all patients for specifed overlap and window length")
parser.add_argument('--wlen',help='Specify window length', type = int)
parser.add_argument('--overlap',help = "Specify overlap % as decimal", type = int)
...
for patient in patientwise_data.keys():
